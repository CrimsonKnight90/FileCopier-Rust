...
//! - [`pipeline`]    — Componentes del pipeline: lector, escritor.
...
//! - [`buffer_pool`] — Pool de buffers RAII con devolución automática.
//! - [`os_ops`]      — Trait mínimo de operaciones de SO (preallocate, copy_metadata).
...
pub use buffer_pool::{Buffer, BufferPool, PooledBuffer};
